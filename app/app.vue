  ...
  <div>
    ...
    <div class="container">
      ...
      <header class="hero">
        ...
        <p>I'm a student at Concordia University passionate about software development, problem-solving, and creating
          clean, user-friendly applications.</p>
      ...
      <section id="work-projects">
        ...
        <div class="grid">
          <ProjectCard v-for="(project, index) in workProjects" :key="index" :title="project.title"
            :description="project.description" :link="project.link" :tags="project.tags" />
        </div>
      </section>
      ...
      <section id="personal-projects">
        ...
        <div class="grid">
          <ProjectCard v-for="(project, index) in personalProjects" :key="index" :title="project.title"
            :description="project.description" :link="project.link" :tags="project.tags" />
        </div>
      </section>
      <!-- 
...
const personalProjects = [
  {
    title: '0DTE Spy Options History',
    description: 'A high-performance financial dashboard engineered for historical 0DTE options analysis. Features a custom Depth of Market (DOM) strike ladder and utilizes WebAssembly DuckDB to query Parquet datasets directly in the browser.',
    link: 'https://optionviewer.zakabdi.dev',
    tags: ['Nuxt', 'Vue', 'DuckDB', 'Python']
  },
  {
